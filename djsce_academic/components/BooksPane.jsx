  ...
  return (
    ...
    <div className="bg-[#dbc397] w-full m-3 rounded-2xl p-3 md:p-5 lg:p-6 flex flex-col sm:h-full border-amber-900 border-2">
      ...
      <input
        ...
        className="w-full p-3 md:p-4 border-2 border-amber-700 text-xs md:text-sm lg:text-base text-amber-900 font-bold font-mono rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-900"
      />
      
      {/* Items wrapper space increases on larger screens */}
      <div id="results-list" className="mt-6 flex-1 overflow-y-auto space-y-3 md:space-y-4">
