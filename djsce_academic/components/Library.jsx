...
const Library = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col m-3 md:flex-row md:items-start items-center">
        <div className="w-full md:w-3/5 max-w-xl items-center flex">
          <BooksPane />
        </div>
        
        {/* Unified Layout Container: The background tiles are now constrained inside this amber border */}
        <div 
          className="relative m-3 z-10 grid grid-cols-13 px-5 py-4 border-2 border-amber-800 bg-[#c2b8ac]"
          style={{
            display: "grid",
            gridTemplateColumns: "24px 24px 24px 24px 35px 50px 35px 24px 24px 24px 24px", 
            gridTemplateRows: "76.8px 76.8px 76.8px 76.8px 48px 48px 48px 48px 36px", 
          }}
        >
          ...
          >
            {tiles.map((_, i) => (
              <div
                key={i}
                className="border-[0.5px] border-slate-300/30" // Subtle grid line overlay over base background color
              />
            ))}
          </div>

          {/* Map Layout Elements */}
          <div className="col-span-3 self-center place-content-center flex h-[12px] flex-col relative z-10"> 
            <WoodenRack
              side="LH"
              number="13"
              id="wdn-lh-13"
          ...
          <div className="col-span-1 self-center flex h-[48px] relative z-10">
            <SteelBlock
              id="stl-b-12"
              side="B"
              number="12"
          ...
          <div className="col-span-1 -ml-10 flex h-full flex-col items-center justify-end pb-0 relative z-10">
          </div>

            <div className="col-span-3 place-content-center self-center flex h-[12px] flex-col relative z-10">
              <WoodenRack
                id="wdn-rh-3"
                side="RH"
                number="3"
          ...
          <div className="col-span-7 relative z-10"></div>
          ...
          <div className="col-span-3 flex items-end relative z-10">
            <div className="backdrop-blur-xl w-full flex border border-[#875003] flex-col items-center justify-between">
              <span className="text-[9.6px] font-mono text-[#875003]">↑</span> 
              <span className="text-[9.6px] font-mono text-[#875003]">
                Entrance
              </span>
            </div>
          </div>
